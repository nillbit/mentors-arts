...
import contactus_svg from "../assets/contactus/contactus_svg.svg" 
import mentors from "../assets/contactus/mentors.png"

function Contactus() {
  return (
    <div className='bg-gradient-to-b from-[#FFFDD0] relative to-[#FFF] min-h-[300px]'>
        <img data-aos="fade-up" src={contactus_svg} data-aos-duration="2000" alt="contact us image" className='w-[100%]'  />
        <div className='absolute top-0 w-[80%] mx-[10%] flex items-center justify-center h-full gap-4'>
            ...
            <div>
                ...
                <img data-aos="fade-up" data-aos-duration="1000" src={mentors
                } className='rounded-md' width={600} alt="" />
            </div>
            <div className='p-4'>
