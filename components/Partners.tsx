...
import lbda from "../assets/companies/lbda.png"
import logo from "../assets/logo.svg"
import ugenya from "../assets/companies/ugenya.png"
import aldai from "../assets/companies/aldai.png"
import peaceCorps from "../assets/companies/peace_corps.png"
import worldvision from "../assets/companies/worldvision.png"
import oriwo from "../assets/companies/oriwo.png"
...
{/* companies logo */}
<img data-aos="fade-up" data-aos-duration="3500" src={ugenya} className='absolute  left-[66.5%] w-[53px] h-[50px] scale-[1.5] z-10' alt="" />
<img data-aos="fade-up" data-aos-duration="3500" src={aldai} className='absolute  top-[16%] w-[53px] h-[50px] z-10' alt="" />
<img src={lbda} className='absolute  left-[22.5%] w-[53px] h-[50px] z-10' alt="" />
<img data-aos="fade-up" data-aos-duration="3000" src={peaceCorps} className='absolute  bottom-[16%] w-[53px] h-[50px] z-10' alt="" />
<img data-aos="fade-up" data-aos-duration="4000" src={worldvision} className='absolute bottom-[36%] left-[57%] w-[53px] h-[50px] z-10 ' alt="" />
<img data-aos="fade-up" data-aos-duration="6000" src={oriwo} className='absolute bottom-[56%] left-[39%] w-[53px] h-[50px] z-10 '  alt="" />
<img src={logo} className='absolute  w-[53px] h-[50px] z-10 '  alt="" />
</div>
