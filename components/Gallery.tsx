  ...
  return (
    <div className='mt-[100px]'>
        <div className='flex justify-center'>
            ...
            <img className='absolute top-0 z-0 ' src="../assets/gallery/gallery_background.svg" alt="gallery background" />
            </div>
        </div>
        {/* display */}
        <div className=' flex flex-row items-center justify-center my-[100px] w-[90%] mx-[5%]'>
            <img className='translate-x-[50%] translate-y-[90%]' src="../assets/gallery/gallery_blue.svg" alt="left image" />
            <div className='w-[300px] h-[400px]' data-aos="flip-right" data-aos-duration="800"><div  className='w-full h-full hover:scale-[1.3] transition-all duration-500 hover:z-10 rounded-[20px] bg-gray-500 -rotate-24 translate-y-[20%]' style={{backgroundImage:'url("../assets/gallery_pics/woman.webp")',backgroundSize:"cover",backgroundRepeat:"no-repeat",backgroundPosition:"center"}} ></div></div>
            <div className='w-[300px] h-[400px]' data-aos="flip-right" data-aos-duration="900"><div className='w-full h-full hover:scale-[1.3] transition-all duration-500 hover:z-10 rounded-[20px] bg-gray-500 -rotate-12 translate-y-[5%]' style={{backgroundImage:'url("../assets/gallery_pics/abstract.webp")',backgroundSize:"cover",backgroundRepeat:"no-repeat",backgroundPosition:"center"}}></div></div>
            <div className='w-[300px] h-[400px]' data-aos="flip-right" data-aos-duration="1000"><div className='w-full h-full hover:scale-[1.3] transition-all duration-500 hover:z-10 rounded-[20px] bg-gray-500 rotate-6' style={{backgroundImage:'url("../assets/gallery_pics/waterpaint.webp")',backgroundSize:"cover",backgroundRepeat:"no-repeat",backgroundPosition:"center"}}></div></div>
            <div className='w-[300px] h-[400px]' data-aos="flip-right" data-aos-duration="1000"><div className='w-full h-full hover:scale-[1.3] transition-all duration-500 hover:z-10 rounded-[20px] bg-gray-500 rotate-12 translate-y-[5%]' style={{backgroundImage:'url("../assets/gallery_pics/tree.webp")',backgroundSize:"cover",backgroundRepeat:"no-repeat",backgroundPosition:"center"}}></div></div>
            ...
            style={{backgroundImage:'url("../assets/gallery_pics/fox.webp")',backgroundSize:"cover",backgroundRepeat:"no-repeat",backgroundPosition:"center"}}></div></div>
            <img className='translate-y-[90px] -translate-x-[20%]' src="../assets/gallery/gallery_orange.svg" alt="left image" />
        </div>
        <div data-aos="fade-up" data-aos-duration="1000" className='flex items-center justify-center flex-col mb-10'>
          ...
          <img  src="../assets/gallery/gallery_green.svg" alt="centre image" />
