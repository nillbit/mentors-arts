  ...
  return (
    <div id='services' className='min-h-screen'>
      ...
      <div data-aos="fade-up" data-aos-duration="1000" className='mt-10  flex items-center justify-center relative'>
        <img src="../assets/services_logo_background.svg" width={350} alt="services background" />
      ...
      <div className='grid grid-cols-2  gap-10 mt-10 w-[90%] mx-[5%] min-h-[400px] pb-10'>
        ...
        <div data-aos="fade-up" data-aos-duration="1000" className='border-2  border-[#FF9100] w-full rounded-sm p-4 relative backdrop-blur-[10px]'>
          ...
          <img src="../assets/fine_art/fine_art_bottom_right.svg" className='absolute -right-4' alt="" />
          <img src="../assets/fine_art/fine_art_top_right.svg" className='absolute -top-4 -right-2' alt="" />
          <img src="../assets/fine_art/fine_art_bottom_left.svg" className='absolute -bottom-3 -left-2' alt="" />
          <img src="../assets/fine_art/fine_art_letter_drawing.svg" className='absolute top-[20%] left-[8%] z-0 ' alt="" />
        </div>
        ...
        <div data-aos="fade-up" data-aos-duration="1000" className='border-2 border-[#673098] w-full rounded-sm p-4 relative backdrop-blur-[10px]'>
          ...
          <img src="../assets/graphic_design/graphic_design_bottom_left.svg" className='absolute -bottom-2 -left-2 z-0 ' alt="" />
          <img src="../assets/graphic_design/graphic_design_bottom_right.svg" className='absolute -bottom-3 -right-2 z-0 ' alt="" />
          <img src="../assets/graphic_design/graphic_design_top_left.svg" className='absolute top-[20%] left-[8%] z-0 ' alt="" />
          <img src="../assets/graphic_design/graphic_design_top_right.svg" className='absolute -top-[5%] right-[8%] z-0 ' alt="" />
        ...
        <div data-aos="fade-up" data-aos-duration="1200" className='border-2 border-[#62ABFC] w-full rounded-sm p-4 relative backdrop-blur-[10px]'>
          ...
          <img src="../assets/promotional_materials/pm_bottom_right.svg" className='absolute -bottom-2 -right-3.5 z-0 ' alt="" />
          <img src="../assets/promotional_materials/pm_top_left.svg" className='absolute top-[20%] left-[8%] z-0 ' alt="" />
          <img src="../assets/promotional_materials/pm_top_right.svg" className='absolute top-[5%] right-[8%] z-0 ' alt="" />
...
Fliers,Bronchures,Reports,Newsletters,Books,Magazines,Identity Cards etc.. </p>
          ...
          <img src="../assets/printing/dp_bottom_left.svg" className='absolute -bottom-2 -left-2 z-0 ' alt="" />
          <img src="../assets/printing/dp_bottom_right.svg" className='absolute -bottom-3 -right-2 z-0 ' alt="" />
          <img src="../assets/printing/dp_top_left.svg" className='absolute top-[6%] left-[15%] z-0 ' alt="" />
          <img src="../assets/printing/dp_top_right.svg" className='absolute -top-[5%] -right-[2%] z-0 ' alt="" />
        </div>
